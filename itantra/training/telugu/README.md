# iTantra Telugu Domain Training Pipeline

This directory contains the pipeline for fine-tuning the Telugu speech model on the real-world iTantra field dataset.
