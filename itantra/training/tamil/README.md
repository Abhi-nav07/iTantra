# iTantra Tamil Domain Training Pipeline

This directory contains the pipeline for fine-tuning the Tamil speech model on the real-world iTantra field dataset.
