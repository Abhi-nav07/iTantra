# iTantra Kannada Domain Training Pipeline

This directory contains the pipeline for fine-tuning the Kannada speech model on the real-world iTantra field dataset.
