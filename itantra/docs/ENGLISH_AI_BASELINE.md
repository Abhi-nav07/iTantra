# English Real-World Neural Baseline & Training Report
...
## 2. STT Provenance
- **Model:** `indicconformer-sherpa-onnx-en`
...
- **Source:** HuggingFace `csukuangfj/vits-mms-eng`
...
- **Training scripts:** Implemented at `training/english/`
...
- **Hindi → English → Hindi:** STATICALLY VERIFIED / DEVICE NOT TESTED (Generic engine unloads and dynamically loads ONNX graphs cleanly without duplicating logic)
