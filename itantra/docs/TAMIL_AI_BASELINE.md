# Tamil Real-World Neural Baseline & Training Report
...
## 2. STT Provenance
- **Model:** `indicconformer-sherpa-onnx-ta`
...
- **Exact Tamil support verified?** YES
...
- **Source:** HuggingFace `csukuangfj/vits-mms-tam`
- **Original checkpoint:** MMS VITS (Tamil)
- **Exact Tamil support verified?** YES
...
- **Training scripts:** Implemented at `training/tamil/`
...
- **Secure Tamil Unicode:** PASS
- **Hindi → Tamil → Hindi:** STATICALLY VERIFIED / DEVICE NOT TESTED
- **Odia → Tamil → Odia:** STATICALLY VERIFIED / DEVICE NOT TESTED
- **English → Tamil → English:** STATICALLY VERIFIED / DEVICE NOT TESTED
