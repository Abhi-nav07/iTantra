# Malayalam Real-World Neural Baseline & Training Report
...
## 2. STT Provenance
- **Model:** `indicconformer-sherpa-onnx-ml`
...
- **Exact Malayalam support verified?** YES
...
- **Source:** HuggingFace `csukuangfj/vits-mms-mal`
- **Original checkpoint:** MMS VITS (Malayalam)
- **Exact Malayalam support verified?** YES
...
- **Training scripts:** Implemented at `training/malayalam/`
...
- **Secure Malayalam Unicode:** PASS
- **Hindi → Malayalam → Hindi:** STATICALLY VERIFIED / DEVICE NOT TESTED
- **Kannada → Malayalam → Kannada:** STATICALLY VERIFIED / DEVICE NOT TESTED
- **Tamil → Malayalam → Tamil:** STATICALLY VERIFIED / DEVICE NOT TESTED
- **Telugu → Malayalam → Telugu:** STATICALLY VERIFIED / DEVICE NOT TESTED
