# Marathi Real-World Neural Baseline & Training Report
...
## 2. STT Provenance
- **Model:** `indicconformer-sherpa-onnx-mr`
...
- **Source:** HuggingFace `csukuangfj/vits-mms-mar`
...
- **Training scripts:** Implemented at `training/marathi/`
...
- **Hindi → Marathi → Hindi:** STATICALLY VERIFIED / DEVICE NOT TESTED (Generic engine unloads and dynamically loads ONNX graphs cleanly without duplicating logic)
- **English → Marathi → English:** STATICALLY VERIFIED / DEVICE NOT TESTED
