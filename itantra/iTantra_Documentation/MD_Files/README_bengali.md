# iTantra Bengali Domain Training Pipeline

This directory contains the pipeline for fine-tuning the Bengali speech model on the real-world iTantra field dataset.
