# iTantra Marathi Domain Training Pipeline

This directory contains the pipeline for fine-tuning the Marathi speech model on the real-world iTantra field dataset.
