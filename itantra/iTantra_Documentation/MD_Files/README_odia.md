# iTantra Odia Domain Training Pipeline

This directory contains the pipeline for fine-tuning the Odia speech model on the real-world iTantra field dataset.
