# iTantra Gujarati Domain Training Pipeline

This directory contains the pipeline for fine-tuning the Gujarati speech model on the real-world iTantra field dataset.
