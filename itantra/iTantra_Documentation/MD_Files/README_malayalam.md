# iTantra Malayalam Domain Training Pipeline

This directory contains the pipeline for fine-tuning the Malayalam speech model on the real-world iTantra field dataset.
