# iTantra English Domain Training Pipeline

This directory contains the pipeline for fine-tuning the English speech model on the real-world iTantra field dataset.
