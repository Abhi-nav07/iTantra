# Hindi Real-World Neural Baseline & Training Report
...
- **Actual local size:** 197,663,198 bytes
...
- **Source:** HuggingFace `csukuangfj/vits-mms-hin`
...
- **Training scripts:** Implemented at `training/hindi/`
